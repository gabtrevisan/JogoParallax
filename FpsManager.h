...
private:
	...
	static const int MIN_TARGET_FPS = 20.0;
	static const int MAX_TARGET_FPS = 60.0; // If you set this above the refresh of your monitor and enable VSync it'll break! Be aware!
...
public:
	...
	double enforceFPS()
	{
		...
		if (sleepDuration > 0.0)
			Sleep((targetFrameDuration - frameDuration) * 1000);
